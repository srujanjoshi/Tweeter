...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "cTVcZUWNO0htlElQPpGCWBOMV", consumerSecret: "Oyga0YHrDAhj0seSqum8INtN3uaJUoTtMcMzVdTG5wDOftJy2Z")
    var loginSuccess: (() -> ())?
